...
In this publication we will develop a model for a full three dimensional space-time ambiguity function for 3-D ISR systems. This ambiguity function can also be modified to show the ambiguity function within the plasma rest frame to show the actual size of the ambiguity function relative to the moving plasma. 
