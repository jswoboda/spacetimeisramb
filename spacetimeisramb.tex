...
This one pulse is a single sample of a random process. In order to create a usable estimate of the ACF numerous instances of this ACF need to be averaged together to reduce the variance in order to fit the estimate to a theoretical ACF that is tied to specific parameter values.
