...
There are a number of possible approaches  one could apply in order to produce an improved data product from such measurements.  A relatively simple approach involves processing the data in the frame of reference of the moving plasma density field.   The convection velocity is manifested as a bulk Doppler shift in the ISR spectrum. 
